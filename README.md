...
SimPy discrete-event simulation + congestion-aware routing → **85% delay reduction, 50% throughput increase**. Power BI dashboards for KPI visualization.

**AI Travel Itinerary Optimization Platform**  
Full-stack app (React, Django, Gemini API) benchmarking GA/PSO/ACO → **28% performance gain, 19% cost savings**.
